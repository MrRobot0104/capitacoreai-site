...
function exportReportPDF(html) {
  ...
  win.document.write('<!DOCTYPE html><html><head><meta charset="UTF-8"><title>MerakiPilot Security Audit Report</title>');
  win.document.write('<style>');
  win.document.write('* { margin: 0; padding: 0; box-sizing: border-box; }');
  win.document.write('body { font-family: Inter, system-ui, sans-serif; background: #0a0a0a; color: #e0e0e0; padding: 48px; max-width: 900px; margin: 0 auto; }');
  win.document.write('h1 { font-size: 28px; font-weight: 800; color: #FF6A00; margin-bottom: 8px; }');
  win.document.write('h2 { font-size: 20px; font-weight: 700; color: #ffffff; margin: 32px 0 12px; padding-bottom: 8px; border-bottom: 1px solid rgba(255,106,0,0.3); }');
  win.document.write('h3 { font-size: 16px; font-weight: 600; color: #FF6A00; margin: 20px 0 8px; }');
  win.document.write('p, li { font-size: 14px; line-height: 1.7; color: rgba(255,255,255,0.75); margin-bottom: 8px; }');
  win.document.write('strong { color: #ffffff; }');
  win.document.write('code { background: rgba(255,106,0,0.15); color: #FF6A00; padding: 2px 6px; border-radius: 4px; font-size: 12px; }');
  win.document.write('table { width: 100%; border-collapse: collapse; margin: 16px 0; font-size: 13px; }');
  win.document.write('th { background: rgba(255,106,0,0.15); color: #FF6A00; text-align: left; padding: 10px 12px; font-weight: 600; font-size: 11px; text-transform: uppercase; letter-spacing: 0.05em; }');
  win.document.write('td { padding: 10px 12px; border-bottom: 1px solid rgba(255,255,255,0.06); color: rgba(255,255,255,0.75); }');
  win.document.write('tr:hover td { background: rgba(255,106,0,0.04); }');
  win.document.write('hr { border: none; border-top: 1px solid rgba(255,255,255,0.1); margin: 24px 0; }');
  win.document.write('blockquote { border-left: 3px solid #FF6A00; padding-left: 16px; margin: 16px 0; color: rgba(255,255,255,0.6); font-style: italic; }');
  win.document.write('.header { text-align: center; margin-bottom: 40px; padding-bottom: 24px; border-bottom: 2px solid rgba(255,106,0,0.3); }');
  win.document.write('.header img { width: 40px; margin-bottom: 12px; }');
  win.document.write('.header p { color: rgba(255,255,255,0.4); font-size: 12px; }');
  win.document.write('.footer { text-align: center; margin-top: 48px; padding-top: 24px; border-top: 1px solid rgba(255,255,255,0.08); font-size: 11px; color: rgba(255,255,255,0.25); }');
  win.document.write('@media print { body { background: #0a0a0a !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; } }');
  win.document.write('</style></head><body>');
  win.document.write('<div class="header">');
  win.document.write('<h1>MerakiPilot Security Audit</h1>');
  win.document.write('<p>Generated by CapitaCoreAI &middot; ' + new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' }) + '</p>');
  win.document.write('</div>');
  win.document.write(html);
  win.document.write('<div class="footer">Powered by MerakiPilot &middot; CapitaCoreAI &middot; capitacoreai.io</div>');
